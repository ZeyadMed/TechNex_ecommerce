...
class CategoryFilterDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Drawer(
      width: context.responsiveValue<double>(mobile: context.screenWidth * 0.86, smallMobile: context.screenWidth * 0.9, tablet: 420),
      backgroundColor: bg,
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  ...subCategories.map(
                    (subCategory) => RadioListTile<String>(
                      value: subCategory,
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          value: selectedKey,
          isExpanded: true,
          icon: Icon(Icons.keyboard_arrow_down_rounded, color: dark ? Colors.white70 : const Color(0xFF344054)),
